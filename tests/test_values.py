...
class TestValue(unittest.TestCase):
    def test_value_class(self):
        ...
        self.assertRaisesRegex(
            ValueError, "Currency symbol not recognised", Value, "10 mfliepflap"
        )
    ...
    def test_value_class_str(self):
        ...
        self.assertEqual(
            Value(012345678.901, "sat").str("mBTC", decimals=8), "123.45678901 mBTC"
        )
        self.assertEqual(
            Value(012345678.9016, "sat").str("mBTC", decimals=8), "123.45678902 mBTC"
        )
        self.assertEqual(
            Value(012345678.90122, "sat").str("mBTC", decimals=10),
            "123.4567890122 mBTC",
        )
        self.assertEqual(
            Value(012345678.901, "sat").str("mBTC", decimals=1), "123.5 mBTC"
        )
        ...
        self.assertEqual(
            Value("0.00021 YBTC").str(1), "210000000000000000000.00000000 BTC"
        )
    ...
    def test_value_operators_comparison(self):
        ...
        self.assertRaisesRegex(
            ValueError,
            "Cannot compare values from different networks",
            Value.__eq__,
            v1,
            v2,
        )
    ...
    def test_value_operators_arithmetic(self):
        ...
        self.assertRaisesRegex(
            ValueError,
            "Cannot calculate with values from different networks",
            Value.__add__,
            v1,
            v2,
        )
    ...
    def test_value_operators_conversion(self):
        ...
        self.assertEqual(hex(v2.value_sat), "0x775f05a074000")
        self.assertEqual(
            bin(Value("2 BTC").value_sat), "0b1011111010111100001000000000"
        )
