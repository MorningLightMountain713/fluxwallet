...
DATABASEFILE_CACHE_UNITTESTS = os.path.join(str(FW_DATABASE_DIR), 'fluxwalletcache.unittest.sqlite')
DATABASEFILE_CACHE_UNITTESTS2 = os.path.join(str(FW_DATABASE_DIR), 'fluxwalletcache2.unittest.sqlite')
DATABASE_CACHE_POSTGRESQL = 'postgresql://postgres:postgres@localhost:5432/fluxwalletcache.unittest'
