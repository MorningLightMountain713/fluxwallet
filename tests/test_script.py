...
#    Unit Tests for fluxwallet Script class
#    © 2018 May - 1200 Web Development <http://1200wd.com/>
#

import unittest

from fluxwallet.scripts import *
...
class TestStack(unittest.TestCase):
    ...
    def test_stack_op_2dup(self):
        ...
        self.assertRaisesRegex(
            ValueError,
            "Stack op_2dup method requires minimum of 2 stack items",
            Stack([b"\x01"]).op_2dup,
        )
    ...
    def test_stack_op_3dup(self):
        ...
        self.assertRaisesRegex(
            ValueError,
            "Stack op_3dup method requires minimum of 3 stack items",
    ...
    def test_stack_op_2over(self):
        self.assertRaisesRegex(
            ValueError,
            "Stack op_2over method requires minimum of 4 stack items",
    ...
    def test_stack_op_2rot(self):
        ...
        self.assertRaisesRegex(
            IndexError, "pop index out of range", Stack([b"\x02"]).op_2rot
        )
    ...
    def test_stack_op_ifdup(self):
        ...
        self.assertRaisesRegex(
            ValueError,
            "Stack op_ifdup method requires minimum of 1 stack item",
            st.op_ifdup,
        )
    ...
    def test_stack_op_nip(self):
        self.assertRaisesRegex(
            IndexError, "pop index out of range", Stack([b"\x01"]).op_nip
        )
    ...
    def test_stack_op_over(self):
        self.assertRaisesRegex(
            ValueError,
            "Stack op_over method requires minimum of 2 stack items",
            Stack([]).op_over,
        )
        st = Stack.from_ints([1, 2])
    ...
    def test_stack_op_rot(self):
        ...
        self.assertEqual(st.as_ints(), [2, 3, 1])
        self.assertRaisesRegex(
            IndexError, "pop index out of range", Stack([1, 2]).op_rot
        )
    ...
    def test_stack_op_tuck(self):
        ...
        self.assertEqual(st, [b"\x01", b"\x02", b"\x01"])
        self.assertRaisesRegex(
            IndexError, "list index out of range", Stack([2]).op_tuck
        )
    ...
    def test_stack_op_equal(self):
        ...
        self.assertEqual(st, [b""])
        self.assertRaisesRegex(
            IndexError, "pop from empty list", Stack([b"x99"]).op_equal
        )
    ...
    def test_stack_op_1add(self):
        ...
        self.assertRaisesRegex(
            IndexError,
            "Not enough items in list to run operation. Items 0, expected 1",
            Stack([]).op_1add,
        )
    ...
    def test_stack_op_add(self):
        ...
        self.assertRaisesRegex(
            IndexError,
            "Not enough items in list to run operation. Items 1, expected 2",
            st.op_add,
        )
    ...
    def test_stack_op_booland(self):
        ...
        self.assertRaisesRegex(
            IndexError,
            "Not enough items in list to run operation. Items 0, expected 2",
            Stack([]).op_booland,
        )
    ...
    def test_stack_op_within(self):
        ...
        self.assertRaisesRegex(
            IndexError,
            "Not enough items in list to run operation. Items 1, expected 3",
            Stack([b"\1"]).op_within,
        )
    ...
    def test_op_ripemd160(self):
        ...
        self.assertRaisesRegex(
            IndexError, "pop from empty list", Stack([]).op_ripemd160
        )
    ...
    def test_stack_op_hash160(self):
        st = Stack(
            [
                bytes.fromhex(
                    "0298ddb14f0a9871c4755985f0ece53f99580d243474e5e300078f3dad809b3d45"
                )
            ]
        )
    ...
    def test_stack_op_checksig(self):
        ...
        sig = (
            "3044022065affcfb58c7e4a8dd2ad787fb069e623dc1f8160b664a17695fcc2ed5c16be002206803240c5f9ba90d3ad2eab"
        ...
        sig = (
            "3044022065affcfb58c7e4a8dd2ad787fb069e623dc1f8160b664a17695fcc2dd5c16be002206803240c5f9ba90d3ad2eab"
            "327fa4e6940cf74d639bfcde0f9d2aeb91182df5b01"
        )
        st = Stack([bytes.fromhex(sig), bytes.fromhex(key)])
        self.assertTrue(st.op_checksig(txid))
        ...
        self.assertRaisesRegex(
            IndexError,
            "pop from empty list",
            Stack([bytes.fromhex(key)]).op_checksig,
            txid,
        )
    ...
    def test_op_stack_op_checksigverify(self):
        ...
        sig = (
            "70b55404702ffa86ecfa4e88e0f354004a0965a5eea5fbbd297436001ae920df5da0917d7bd645c2a09671894375e3d353"
    ...
    def test_op_stack_op_checkmultisig(self):
        ...
        sig2 = (
            b"0F\x02!\x00\xbb\xb0!\x81\xf1\x10\xa1\x93\x8b\xa6N\xec\xafZV0\xd4\xa6\x91cb\x04c\xad\xc9\xb0#\xdb\xbe"
            b"\x7f!z\x02!\x00\x80\xd7\xef\"\xec\xd4\x08\x9a@nb'\xb4\x88\xfd'\xf4\x02jg\x9b:\x1b\xf8ck\xbe\xaf<"
            b"\x1a\x07n\x01"
        )
        key1 = (
            b"\x04\xdf_j\x9b\x95\xa9\xdb>n\xea!\xfa\xf0\\\xe1\x13p\xd3\x8dW\x14\xf6\x04\xf4\xff\xeb\x9dA\x8a\x1a~"
            b"O \xea\x16\xe2\xe8J\xf1\xd7\xde\xac]\xa3\xcc\xf8\xf1\x8c\x1d\x18Sbd\xa6\xe9\xccMv\x04\xa4z\xe7\xcb\xc5"
        )
        key2 = (
            b'\x042J\xef\x0f65R"n\xf7@\xff|\x82\xacI\x80\x9am\xee\x16y\xde<\x9c~|\x14\x0b\x04\x16\x05;\xe3\x8d\x19'
            b"\xc9?\xbeM\xd7\x1b\xfds\xaa?\rK\x87\xe1\x92\x06_\xb3X3\xc4B\xb8qn\x96\x8d?"
        )
        key3 = (
            b"\x04\x13\x07\x04Za\xc6\x9c\x84\x03\xb1\x07n\x0f4\xa8=\r\xcc\x1f\xacc\x07\xbe\xbf\n\x11R\xf0\x1dX\xda"
            b"w\xe3\n\x19\xcd\xeds<ie-\xc8y\xfb,4S\xbb8wj\xef\xe6\x12\x1e<\xf8\xde<Y\xa8'\xcc"
        )
        transaction_hash = bytes.fromhex(
            "feb5df818d0120d3d08853a375e802267ea2cdfb80bfde37027606fac5219e2f"
        )
...
class TestScriptTypes(unittest.TestCase):
    ...
    def test_script_type_p2sh(self):
        s = Script.parse_bytes(
            bytes.fromhex("a914e3bdbeab033c7e03fd4cbf3a03ff14533260f3f487")
        )
    ...
    def test_script_type_nulldata(self):
        ...
        self.assertEqual(
            "985f23805edd2938e5bd9f744d36ccb8be643de00b369b901ae0b3fea911a1dd",
            s.commands[1].hex(),
        )
    ...
    def test_script_type_multisig(self):
        scr = (
            "514104fcf07bb1222f7925f2b7cc15183a40443c578e62ea17100aa3b44ba66905c95d4980aec4cd2f6eb426d1b1ec45d7672"
    ...
    def test_script_multisig_errors(self):
        ...
        self.assertRaisesRegexp(
            ScriptError, "3 keys found but 2 keys expected", Script.parse, scr
        )
        self.assertRaisesRegexp(
            ScriptError,
            "Number of signatures required \(3\) is higher then number of keys \(2\)",
            Script.parse,
    ...
    def test_script_deserialize_sig_pk(self):
        scr = (
            "493046022100cf4d7571dd47a4d47f5cb767d54d6702530a3555726b27b6ac56117f5e7808fe0221008cbb42233bb04d7f28a"
        ...
        self.assertEqual(
            s.keys[0].public_byte,
            bytearray(
                b"\x04-\xaa\x931^\xeb\xbe,\xb9\xb5\xc3P]\xf4\xc6\xfbl\xac\xa8\xb7Vx`\x98"
...
class TestScript(unittest.TestCase, CustomAssertions):
    def test_script_verify_transaction_input_p2pkh(self):
        ...
        self.assertEqual(
            s.blueprint, ["signature", "key", 118, 169, "data-20", 136, 172]
        )
        self.assertEqual(s.script_types, ["sig_pubkey", "p2pkh"])
        self.assertEqual(
            str(s), "signature key OP_DUP OP_HASH160 data-20 OP_EQUALVERIFY OP_CHECKSIG"
        )
        transaction_hash = bytes.fromhex(
    ...
    def test_script_verify_transaction_input_p2sh_multisig(self):
        ...
        self.assertEqual(
            str(s),
            "OP_0 signature signature OP_2 key key key OP_3 OP_CHECKMULTISIG OP_HASH160 "
            "data-20 OP_EQUAL",
        )
        transaction_hash = bytes.fromhex(
            "5a805853bf82bcdd865deb09c73ccdd61d2331ac19d8c2911f17c7d954aec059"
        )
        self.assertTrue(s.evaluate(message=transaction_hash))
    ...
    def test_script_verify_transaction_input_p2sh_multisig_huge(self):
        ...
        self.assertEqual(
            str(s),
            "OP_0 signature signature signature signature signature signature signature "
        ...
        transaction_hash = bytes.fromhex(
            "8d190df3d02369999cad3eb222ac18b3315ff2bdc449b8fb30eb14db45730fe3"
        )
    ...
    def test_script_verify_transaction_input_p2wpkh(self):
        ...
        lock_script = (
            op.op_dup.to_bytes(1, "little")
            + op.op_hash160.to_bytes(1, "little")
            + bytes.fromhex("147022028ab0454769a1ff6a5c94ce1a719d8f1b4b")
            + op.op_equalverify.to_bytes(1, "little")
            + op.op_checksig.to_bytes(1, "little")
        )
        witnesses = varstr(
            bytes.fromhex(
                "3044022037fa29824b6ced7631d34154fba9922c477615c215df0ff4ef446dda9e64a8560220283c1e6f7fb8cd2cf68a148e"
                "7cce8f1b43dd4d162224b80b0cab38989ebf485401"
            )
        ) + varstr(
            bytes.fromhex(
                "02f9009565c28990216c5d09ea8842b9b0e668346695f9aa275a8ae8d5e73fdca3"
            )
        )
        ...
        transaction_hash = bytes.fromhex(
            "d63e8748dd7fd62d7530c6e611f8103b906318e01ef80a107832c9166159a58a"
        )
        self.assertTrue(s.evaluate(message=transaction_hash))

    def test_script_verify_transaction_input_p2wsh(self):
        lock_script = (
            op.op_sha256.to_bytes(1, "little")
            + bytes.fromhex(
                "20701a8d401c84fb13e6baf169d59684e17abd9fa216c8cc5b9fc63d622ff8c58d"
            )
        ...
        transaction_hash = bytes.fromhex(
            "43f0f6dfb58acc8ed05f5afc224c2f6c50523230bfcba5e5fd91d345e8a159ab"
        )
    ...
    def test_script_verify_transaction_output_return(self):
        script = bytes.fromhex(
            "6a26062c74e4b802d60ffdd1daa37b848e39a2b0ecb2de72c6ca24d71b87813b5e056cb7f1e8c8b0"
        )
        s = Script.parse_bytes(script)
    ...
    def test_script_add(self):
        # Verify txid 6efe4f943b7898c4308c67b47bac57551ff41977edc254eafb0436467632450f, input 0
        lock_script = Script.parse_bytes(
            bytes.fromhex("76a914f9cc73824051cc82d64a716c836c54467a21e22c88ac")
        )
        unlock_script = Script.parse_bytes(
            bytes.fromhex(
                "483045022100ba2ec7c40257b3d22864c9558738eea4d8771ab97888368124e176fdd6d7cd8602200f47c8d0c437df1ea8f98"
                "19d344e05b9c93e38e88df1fc46abb6194506c50ce1012103e481f20561573cfd800e64efda61405917cb29e4bd20bed168c5"
                "2b674937f535"
        ...
        script = unlock_script + lock_script
        self.assertEqual(
            script.blueprint, ["signature", "key", 118, 169, "data-20", 136, 172]
        )
        self.assertEqual(script.script_types, ["sig_pubkey", "p2pkh"])
        self.assertEqual(
            str(script),
            "signature key OP_DUP OP_HASH160 data-20 OP_EQUALVERIFY OP_CHECKSIG",
        )
        transaction_hash = bytes.fromhex(
            "12824db63e7856d00ee5e109fd1c26ac8a6a015858c26f4b336274f6b52da1c3"
        )
    ...
    def test_script_create_simple(self):
        ...
        self.assertEqual(
            repr(script), "<Script([op.op_2, op.op_5, op.op_sub, op.op_1])>"
        )
    ...
    def test_script_serialize(self):
        ...
        sig1 = (
            b"0E\x02!\x00\xde\x8fDH\xe2\xd2\xe7F\x18>B\xe4\xfd\x87\xb8\x0b\x87\xfb\xb1\xd7ZYL\xa4\x08\x12\xe5\x07v"
            b'\xd5\xd6\x14\x02 ]kH\xfe\x1c\xc5\x90\r\xf6fF\x085\xfa\x10C\xb8^\x92":\x15\x87\x98\x95\xf1(\t\xdb?}'
            b"\xe3\x01"
        )
        sig2 = (
            b"0D\x02 hp\xd6\xdc\r\xe3\xef\xd5\xd6\xe1u\xd3i\xc8\x81KN\x86X\x96S!\x8c\xe9R\xe6\xbc\xc1\xa4>\xd5\xa3"
            b"\x02 U\xafu\xda\xad`\x92$\xd1\xf6Jc5\xeb\xb9\xe1M\xeb!L&\xec'{\xb2\xaeW2n\xa7\xb3\x02\x01"
        )
        key1 = bytes.fromhex(
            "02cd9107f8f1505ffd779bb7d8596ee686afc116e340f01b435871a038922255eb"
        )
        key2 = bytes.fromhex(
            "0297faa15d33e14e80ca8a8616030b677941245fea12c4ef2ca28b14bd35ed42e1"
        )
        key3 = bytes.fromhex(
            "0221b302fb92b25f171f1cd57bd22e60a1d2956f5831df17d94b3e9c3490aad598"
        )
        redeemscript = Script([op.op_2, key1, key2, key3, op.op_3, op.op_checkmultisig])
        script_hash = bytes.fromhex(
            "b0fcc0caed77aeba9786f39920151162dfaf90e679aafab7a71e9b978e7d3f39"
        )
        self.assertEqual(
            redeemscript.raw.hex(),
        ...
        script = (
            Script([op.op_0, sig1, sig2])
            + Script(redeemscript.commands)
            + Script([op.op_sha256, script_hash, op.op_equal])
        )
        self.assertEqual(
            str(script),
            "OP_0 signature signature OP_2 key key key OP_3 OP_CHECKMULTISIG OP_SHA256 "
            "data-32 OP_EQUAL",
        )
        self.assertTrue(
            script.evaluate(
                message=transaction_hash,
                tx_data={"redeemscript": redeemscript.serialize()},
            )
        )
    ...
    def test_script_deserialize_sig_pk2(self):
        spk = (
            "473044022034519a85fb5299e180865dda936c5d53edabaaf6d15cd1740aac9878b76238e002207345fcb5a62deeb8d9d80e5"
    ...
    def test_deserialize_script_with_sizebyte(self):
        script_size_byte = (
            b"\x16\x00\x14y\t\x19r\x18lD\x9e\xb1\xde\xd2+x\xe4\r\x00\x9b\xdf\x00\x89"
        )
    ...
    def test_script_large_redeemscript_packing(self):
        ...
        redeemscript = (
            "5f2103938f49f584ecdb52041cab7e8ac2b241feec7ff00c2823ee6e249425a2df18d52103938f49f584ecdb5204"
