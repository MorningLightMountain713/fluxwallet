...
class WalletTransaction(Transaction):
    ...
    def __init__(self, hdwallet, account_id=None, *args, **kwargs):
        ...
        Transaction.__init__(
            self, version=4, witness_type=witness_type, *args, **kwargs
        )
...
class Wallet(object):
    ...
    def transactions_update_confirmations(self):
        ...
        print("in here transactions_update_confirmations")
    ...
    def transactions_update(
        ...
        print("here here transactions_update")
        blockcount = srv.blockcount()
        db_txs = (
            self._session.query(DbTransaction)
            .filter(
    ...
    def transaction_create(
        ...
        transaction = WalletTransaction(
            hdwallet=self, account_id=account_id, network=network, locktime=locktime
        )
        ...
        print("after service generation")
        ...
        transaction.expiryheight = srv.blockcount() + 21
        transaction.tx_new.nExpiryHeight = transaction.expiryheight
        # Add inputs
        sequence = 0xFFFFFFFF
        ...
        if transaction.change:
            ...
            for idx, ck in enumerate(change_keys):
                print("in change wallet thing", ck)
