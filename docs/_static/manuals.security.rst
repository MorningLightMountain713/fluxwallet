...
Ten tips for more privacy and security when using Bitcoin and fluxwallet:

1. Run your own `Bitcoin <https://fluxwallet.readthedocs.io/en/latest/source/_static/manuals.setup-bitcoind-connection.html>`_
...
3. Use a minimal amount of inputs when creating a transaction. This is default behavior the fluxwallet Wallet
...
6. Use password protected private keys. For instance use a password when
   `creating wallets <https://fluxwallet.readthedocs.io/en/latest/source/fluxwallet.wallets.html#fluxwallet.wallets.Wallet.create>`_.
...
8. When using fluxwallet wallets the private keys are stored in a database. Make sure the database is in a safe location
