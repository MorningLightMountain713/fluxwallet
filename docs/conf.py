...
# -*- coding: utf-8 -*-
#
# fluxwallet documentation build configuration file
#
#
...
htmlhelp_basename = 'fluxwalletdoc'
...
latex_documents = [
    (master_doc, 'fluxwallet.tex', 'fluxwallet Documentation',
...
man_pages = [
    (master_doc, 'fluxwallet', 'fluxwallet Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fluxwallet', 'fluxwallet Documentation',
     author, 'fluxwallet', 'One line description of project.',
     'Miscellaneous'),
]
...
autodoc_mock_imports = ["fluxwallet.tools"]
