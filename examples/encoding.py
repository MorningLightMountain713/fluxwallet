...
examples = [
    ...
    (
        ...
        b"\xdap%\x9dOg\x95\xe9\x8a\xf2\x0enW`3\x14\xa6b\xa4\x9c\x19\x81\x99",
        256,
        16,
    ),
]
...
addrs = [
    "1KcBA4i4Qqu1oRjobyWU3R5UXUorLQ3jUg",
    "1111111111111111111114oLvT2",
    "1QLbz7JHiBTspS962RLKV8GndWFwi5j6Qr",
]
for addr in addrs:
    print(
        "Public Key Hash of address '%s' is '%s'"
        % (addr, addr_to_pubkeyhash(addr, True))
    )
...
redeemscript = (
    "5221023dd6aeaa2acb92cbea35820361e5fd07af10f4b01c985adec30848b424756a6c210381cd2bb2a38d939fa677a5dcc"
...
der_signature = (
    "3045022100f952ff1b290c54d8b9fd35573b50f1af235632c595bb2f10b34127fb82f66d18022068b59150f825a81032c"
...
print(
    "Number 1000 as Varbyte Integer (hexstring): %s"
    % to_hexstring(int_to_varbyteint(1000))
)
print(
    "Converted back (3 is size in bytes: 1 size byte + integer in bytes): ",
    varbyteint_to_int(to_bytes("fde803")),
)

# Normalize data
print("\n=== Normalizations ===")
data = [
    "guion cruz envío papel otoño percha hazaña salir joya gorra íntimo actriz",
    "\u2167",
    "\uFDFA",
...
pkh_converted = addr_bech32_to_pubkeyhash(
    address, prefix="bc", include_witver=True, as_hex=True
)
