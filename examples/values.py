...
print(
    v.str(denominator=0.01)
)  # a centi-bitcoin, not really standard, but you could use it
...
print(
    Value("50000 sat") == Value("5000 fin")
)  # 1 Satoshi equals 10 Finney, see https://en.bitcoin.it/wiki/Units
...
print(
    "When serializing transactions or scripts there is a bytes or hex version available"
)
